...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s euncoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  euncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded euncoin transaction") + "\n" +
              "  euncoin-tx [options] -create [commands]   " + _("Create hex-encoded euncoin transaction") + "\n" +
              "\n";
