...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/euncoin-project/euncoin>";
    const std::string URL_WEBSITE = "<https://euncoin.org>";
